...
<v-container fluid style="width:1000px">
  <v-row dense>
    <v-col>
     <v-img
              src= "../../assets/img/img_store_photo_1.png"
  ...
  <v-hover v-slot="{ hover }">
    ...
    >
      <v-img
        :aspect-ratio="16/9"
        src="../../assets/img/img_store_map_1.png"
        height="500px"
      >
      <div class="mapfont">
        ...
        <v-expand-transition>
          <div
            ...
            style="height: 100%;"
          >
             <p class="mt-10 pt-10">대박정육점 목련점 상세위치<br><br>대전광역시 서구 동서대로973번길 31 <br><br> 지번:대전광역시 서구 내동 163-3 <br><br> 안골 어린이공원에서 3분 거리</p>
          </div>
        </v-expand-transition>
      </v-img>
      </v-card>
...
<v-row>
  <v-col>
    <h1>대박정육점-목련점 <v-btn elevation="2" height="50px" class="mb-2"> 
